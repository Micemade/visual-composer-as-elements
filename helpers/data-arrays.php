...
$block_enter_anim_arr = array(
	...
	'fade-in-zoom-big'	=> 'Fade in zoom big',
	...
	'stretch-down'		=> 'Stretch down',
	'turn-in-up'		=> 'Turn in up',
	'turn-in-down'		=> 'Turn in down',

);

$hover_animation = array(
	'no-hover-anim'				=> 'None',
	'hover-drop-in'				=> 'Drop in',
	'hover-fade-in-down'		=> 'Fade in down',
	'hover-fade-in-left'		=> 'Fade in left',
	'hover-fade-in-right'		=> 'Fade in right',
	'hover-fade-in-up'			=> 'Fade in up',
	'hover-fade-in-zoom-big'	=> 'Fade in zoom big',
	'hover-fade-in-zoom'		=> 'Fade in zoom',
	'hover-fade-in'				=> 'Fade in',
	'hover-newspaper'			=> 'Newspaper',
	'hover-pop-in'				=> 'Pop in',
	'hover-rise-in'				=> 'Rise in',
	'hover-slide-in-left'		=> 'Slide in left',
	'hover-slide-in-right'		=> 'Slide in right',
	'hover-stretch-up'			=> 'Stretch up',
	'hover-stretch-down'		=> 'Stretch down',
	'hover-turn-in-up'			=> 'Turn in up',
	'hover-turn-in-down'		=> 'Turn in down',
);
...
$gmap_styles = array(
	"None"				=> "none",
	"Subtle greyscale"	=> "subtle_greyscale",
	"Blue Essence"		=> "blue_essence",
	...
	"Flat map"			=> "flat_map",
	"Cool grey"			=> "cool_grey",
	"Ultra light with labels"=> "ultra_light_labels",
	"Greyscale"			=> "greyscale",
	...
	"RouteXL"			=> "routexl",
	"Subtle"			=> "subtle",
	"Avocado world"		=> "avocado",
	"Lunar landscape"	=> "lunar",
	"Snazzy maps"		=> "snazzy",
	"Red hues"			=> "red_hues",
	"Muted monotone"	=> "muted_monotone",
	"Turquoise Water"	=> "turquoise_water",
	"Cladme"			=> "cladme",
);
