...
add_action( 'wp_ajax_nopriv_load-single-product', 'single_product_ajax' );// for NOT logged in users
add_action( 'wp_ajax_load-single-product', 'single_product_ajax' );// for logged in users

function single_product_ajax () {

	global $post;
	
	$block_id 		= $_POST[ 'block_id' ];
	$single_product = $_POST[ 'single_product' ];
	$block_style	= $_POST[ 'block_style' ];
	$back_color 	= $_POST[ 'back_color' ];
	$hide_image 	= $_POST[ 'hide_image' ];
	$img_format 	= $_POST[ 'img_format' ];
	$no_gallery 	= $_POST[ 'no_gallery' ];
	$slider_navig 	= $_POST[ 'slider_navig' ];
	$slider_pagin 	= $_POST[ 'slider_pagin' ];
	$slider_timing 	= $_POST[ 'slider_timing' ];
	$product_options= $_POST[ 'product_options' ];
	$hide_short_desc= $_POST[ 'hide_short_desc' ];
	$vc_css_item_data_class= $_POST[ 'vc_css_item_data_class' ];
