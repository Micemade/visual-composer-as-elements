...
function vc_ase_as_video_func( $atts, $content = null ) {
	...
	if ( $site == 'youtube' ) {
		$src = 'http://www.youtube-nocookie.com/embed/' . $id; } elseif ( $site == 'vimeo' ) {
		$src = 'http://player.vimeo.com/video/' . $id; } elseif ( $site == 'dailymotion' ) {
			$src = 'http://www.dailymotion.com/embed/video/' . $id; } elseif ( $site == 'yahoo' ) {
			$src = 'http://d.yimg.com/nl/vyc/site/player.html#vid=' . $id; } elseif ( $site == 'bliptv' ) {
				$src = 'http://a.blip.tv/scripts/shoggplayer.html#file=http://blip.tv/rss/flash/' . $id; } elseif ( $site == 'veoh' ) {
				$src = 'http://www.veoh.com/static/swf/veoh/SPL.swf?videoAutoPlay=0&permalinkId=' . $id; } elseif ( $site == 'viddler' ) {
