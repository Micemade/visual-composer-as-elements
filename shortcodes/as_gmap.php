...
if( $api_key !== '' ) {
	...
	<div id="map-<?php echo esc_attr($block_id); ?>-holder" class="vc-ase-element content-block anim-wrap<?php echo ($enter_anim != 'none') ? ' to-anim' :''; echo $css_classes ? ' '. esc_attr($css_classes) : ''; ?>" >
